...
parser.add_argument('--pretrained_vgg', dest='pretrained_vgg', default='/data/private/pretrained_vgg', help='pretrained vggnet directory(only wgan_vgg)')

#set save directory
parser.add_argument('--checkpoint_dir', dest='checkpoint_dir',  default='/data/private/WGAN_VGG/checkpoint', help='check point dir')
parser.add_argument('--test_npy_save_dir', dest='test_npy_save_dir',  default='/data/private/WGAN_VGG/test', help='test numpy file save dir')
